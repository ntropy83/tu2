...
// Speicherpfade definieren
    ...
    static QString maindir = home + "/.local/share/TUII/Projekte/";
    static QString prjdir = home + "/.local/share/TUII/data/";
    static QString lib_index = home + "/.local/share/TUII/index.lib";
#endif
